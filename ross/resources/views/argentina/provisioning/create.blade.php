    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content ibox-form">
                ...
                <form name="create" id="create" action="{{ url('Argentina/provisioning') }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" readonly="readonly">
                    <p class="text-justify">{{ trans('messages.000088') }}</p>
            ...
            $("form#create").submit(function(evt){  
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            url : $('form#create').attr('action'),// la URL para la petición
