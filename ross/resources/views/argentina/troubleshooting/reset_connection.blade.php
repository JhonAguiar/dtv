    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content ibox-form">
                ...
                <form name="reset_connection" id="reset_connection" action="{{ url('Argentina/troubleshooting/reset') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
					    ...
					    <div class="col-sm-3">
					        <div class="form-group">
					            ...
					            <button type="submit" id="btnEnviar" class="btn btn-success btn-block">{{ trans('messages.buttons.20') }}</button>
					        </div>
					    </div>
					</div>
				</form>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() { 
			...
			$("form#reset_connection").submit(function(evt){	 
				evt.preventDefault();
				...
				swal({
				    ...
				    if (isConfirm) {
						...
						$("#spinnerLoader").show();
						$("#data_return").html('&nbsp;');
						var formData = new FormData($('form#reset_connection')[0]);
						$.ajax({
						    url : $('form#reset_connection').attr('action'),// la URL para la petición
