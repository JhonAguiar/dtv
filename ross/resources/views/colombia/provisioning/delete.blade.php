    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content ibox-form">
                ...
                <form name="delete" id="delete" action="{{ url('Colombia/provisioning/destroy') }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" readonly="readonly">
                    <p class="text-justify">
                    	{{ trans('messages.000076') }}
	                </p>
					...
					<div class="row">
					    ...
					    <div class="col-sm-4">
					        <div class="form-group">
					            ...
					            <button type="submit" id="btnEnviar" class="btn btn-success btn-block">{{ trans('messages.buttons.12') }}</button>
					        </div>
					    </div>
					</div>
				</form>
