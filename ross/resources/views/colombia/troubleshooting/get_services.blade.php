    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content ibox-form">
                ...
                <form name="formgeters" id="formgeters" target="targetFrame" action="{{ url('Colombia/troubleshooting/services').'?render=pdf' }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div id="unitaria">
                                    ...
                                    <textarea name="subscriber_identity" id="subscriber_identity" class="form-control" rows="9" maxlength="1200" placeholder="732176000123456, 732176000123457, 732176000123458"></textarea>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group margin-check">
                                <span class="input-group-addon"> 
                                    <input name="get_location" id="get_location" type="checkbox">
                                </span> 
                                <label for="get_location" class="form-control">{{ trans('messages.000025').': Get location' }}</label>
                            </div>
                            <div class="input-group margin-check">
                                <span class="input-group-addon"> 
                                    <input name="massive_fail" id="massive_fail" type="checkbox">
                                </span> 
                                <label for="massive_fail" class="form-control">{{ trans('messages.000025').': Massive Fail' }}</label>
                            </div>
                            <br>
                ...
                <div class="row">
                    Mostrar Activos: <input type="checkbox" class="activos"><br>
                    Mostrar Inactivos: <input type="checkbox" class="inactivos">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() { 
            ...
            $(".activos").on("click" , function(){
                if($(".activos")[0].checked == false && $(".inactivos")[0].checked == false){
            ...
            $( "#btnEnviar" ).click(function() {
                ...
                $.ajax({
                    url : "{{ url('Colombia/troubleshooting/services').'?render=html' }}",
                    type: 'POST',
                    data: formData,
                    cache: false,
                    processData: false,
